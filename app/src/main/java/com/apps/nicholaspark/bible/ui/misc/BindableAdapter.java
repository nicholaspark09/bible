package com.apps.nicholaspark.bible.ui.misc;
...
public abstract class BindableAdapter<T> extends BaseAdapter {
  ...
  @Override public final View getView(int position, View v, ViewGroup container) {
    View view = v;
    if (view == null) {
  ...
  @Override public final View getDropDownView(int position, View v, ViewGroup container) {
    View view = v;
    if (view == null) {
